...
def create_streamlit_app(llm, portfolio, clean_text):
    st.title("📧 AI Business Email Assistant- AutoBizMail")
    ...
    if company_url and st.button("🔍 Pull Company Info"):
        try:
    ...
    generate_btn = st.button("✉️ Generate Emails")
...
if __name__ == "__main__":
    chain = Chain()
    portfolio = Portfolio()
    st.set_page_config(layout="wide", page_title="AI Business Email Assistant- AutoBizMail", page_icon="📧")
